function Footer() {
	return (
		<footer className="bg-gray-900 px-12 py-24">
			<div className="flex flex-row gap-12">
				<div className="flex-[0.6]">
					...
					<p>
						...
						blanditiis debitis, sapiente nobis repudiandae, nisi numquam doloremque
						suscipit sit facere reiciendis aliquam. Ducimus, voluptate tenetur fugiat in
						quaerat consectetur.
					</p>
				</div>
			...
			<p className="text-xs font-semibold text-red-500 mt-4 tracking-widest">
				2024 © CINEVERSE / Ticketing
			</p>
		</footer>
	)
}
